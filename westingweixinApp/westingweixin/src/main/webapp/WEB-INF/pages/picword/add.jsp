...
<script type="text/javascript">
	function add() {
		...
		$.post("<%=request.getContextPath()%>/picword/addByJson" , {
			brief:$("#brief").val(),htmlcontent:htmlEle
...
<body>
<div><input type="text" name="brief" id="brief"/><input type="submit" onclick="add();"/></div>
<div id="mytable" style="display: none;"></div>
<div>
<script type="text/plain" id="myEditor" style="width: 1050px; height: 500px;">
