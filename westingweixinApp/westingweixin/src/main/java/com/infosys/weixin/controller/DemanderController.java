...
public class DemanderController {
    ...
    public @ResponseBody String mydemanders(String currentPage, String pageSize, HttpSession session) {
        ...
        PagerInfo<DemanderDto> userResult = serviceOrderService.listDemanderByKewword(demanderSearchModal);
    ...
    public String register(@RequestParam(value = "fromPath", required = false) String fromPath, String birth,
